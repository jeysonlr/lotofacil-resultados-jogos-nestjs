...
describe('GeonameStateRepository', () => {
    let repository: GeonameStateRepository;
    let mockDataEntity: GeonameStateEntity;
    let mockDataDTO: CreateOrUpdateStateGeonameDto;
    ...
    describe('createState()', () => {
        ...
        //     expect(await repository.createState(mockDataDTO)).toEqual(mockDataEntity);
        // });
    });
