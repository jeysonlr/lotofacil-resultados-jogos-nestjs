SELECT --seleção sobre o resultado do union
    COUNT("colunas") AS "QUANTIDADE_DE_VEZES",
    "colunas" AS "NUMEROS_SORTEADOS"
FROM (
        SELECT "bola1" AS "colunas"
        FROM "lotofacil"
        UNION ALL
        ...
        FROM "lotofacil"
    ) "a" --necessário nomear o union para funcinonar
GROUP BY "colunas"
order by "QUANTIDADE_DE_VEZES" desc
